...
namespace ChessBoardSimulator {
	...
	public:
		...
		MainForm(std::list<Game*> posibleGames)
		{
			...
			for (auto it : posibleGames) {
				Game* game = it;
				IntPtr gameIntPtr = IntPtr(game);
				allGames.Add(gameIntPtr);
			}
		...
		void DisplaySelectionPanel() {
			...
			ActivePlayerName->Visible = false;
			exitGameButton->Visible = false;
			backButton->Visible = false;
			ClearBoardState();
			label82->Text = "Select game to play:";

			interactionPanel->Controls->Clear();
			for each (IntPtr currentItem in allGames)
			{
				Game* game = (Game*)currentItem.ToPointer();
				GameButton^ b = gcnew GameButton;
				String^ message = gcnew String(game->name.c_str());
				b->Text = message;
				b->g=game;
				b->Click += gcnew System::EventHandler(this, &MainForm::gameSelectionButtonClick);
		...
		void ClearBoardState() {
			for each (Control ^ element in DBoard->Controls)
			{
				PictureBox^ picture = (PictureBox^)element;
		...
		void RefreshBoardState() {
			for (auto cc : activeGame->gameboard->bo) {
		...
		void UpdateMoves() {
			activeGame->CalculateAllPosibleMoves(activeGame->activePlayer);
		}
		void startGame(Game* g) {
			activeGame = g;
			activeGame->setupBord();

			DisplayGamePanel();
		}
		void CheckEndGame() {
			if (activeGame->gameStatus.first == true) {
				endGame(activeGame->gameStatus.second);
			}
		}
		void endGame(std::string message) {
			String^ convertedMessage = gcnew String(message.c_str());
			System::Windows::Forms::MessageBox::Show(convertedMessage, "Game Ended",
		...
		void DisplayPieces() {
			...
			auto ff = activeGame->rememberedMovesMap;
			for (auto rr : ff) {
				...
				//b->Size = System::Drawing::Size(260, 50);
				//b->Font = System::Drawing::Font("Microsoft Sans Serif", 12);
				interactionPanel->Controls->Add(b);
			}
		}

		void DisplayMoves(Piece* toMove, std::vector< BoardMove*> rrr) {
			interactionPanel->Controls->Clear();
	...
	private: System::Void endGameButtonClick(System::Object^ sender, System::EventArgs^ e) {
		endGame("Game was canceled.");
	}

	private: System::Void gameSelectionButtonClick(System::Object^ sender, System::EventArgs^ e) {
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->interactionPanel->Controls->Add(this->button19);
			this->interactionPanel->Controls->Add(this->button20);
			this->interactionPanel->Controls->Add(this->button21);
			this->interactionPanel->Controls->Add(this->button22);
			this->interactionPanel->Controls->Add(this->button23);
			this->interactionPanel->FlowDirection = System::Windows::Forms::FlowDirection::TopDown;
			this->interactionPanel->Location = System::Drawing::Point(771, 102);
			this->interactionPanel->Margin = System::Windows::Forms::Padding(2);
			this->interactionPanel->Name = L"interactionPanel";
			this->interactionPanel->Size = System::Drawing::Size(310, 560);
			this->interactionPanel->TabIndex = 3;
			this->interactionPanel->WrapContents = false;
			...
			this->button1->Text = L"aaaaaa bbbbbbb bbbbbbbbcccccccccccccccc";
			this->button1->UseVisualStyleBackColor = true;
			this->button1->Click += gcnew System::EventHandler(this, &MainForm::button1_Click_1);
			// 
			// button2
			// 
			this->button2->Location = System::Drawing::Point(2, 55);
			...
			// button3
			// 
			this->button3->Location = System::Drawing::Point(2, 83);
			...
			// button4
			// 
			this->button4->Location = System::Drawing::Point(2, 111);
			...
			// button5
			// 
			this->button5->Location = System::Drawing::Point(2, 139);
			this->button5->Margin = System::Windows::Forms::Padding(2);
			this->button5->Name = L"button5";
			this->button5->Size = System::Drawing::Size(70, 24);
			...
			// button6
			// 
			this->button6->Location = System::Drawing::Point(2, 167);
			this->button6->Margin = System::Windows::Forms::Padding(2);
			this->button6->Name = L"button6";
			this->button6->Size = System::Drawing::Size(70, 24);
			...
			// button7
			// 
			this->button7->Location = System::Drawing::Point(2, 195);
			this->button7->Margin = System::Windows::Forms::Padding(2);
			this->button7->Name = L"button7";
			this->button7->Size = System::Drawing::Size(70, 24);
			...
			// button8
			// 
			this->button8->Location = System::Drawing::Point(2, 223);
			this->button8->Margin = System::Windows::Forms::Padding(2);
			this->button8->Name = L"button8";
			this->button8->Size = System::Drawing::Size(70, 24);
			...
			// button9
			// 
			this->button9->Location = System::Drawing::Point(2, 251);
			this->button9->Margin = System::Windows::Forms::Padding(2);
			this->button9->Name = L"button9";
			this->button9->Size = System::Drawing::Size(70, 24);
			...
			// button10
			// 
			this->button10->Location = System::Drawing::Point(2, 279);
			this->button10->Margin = System::Windows::Forms::Padding(2);
			this->button10->Name = L"button10";
			this->button10->Size = System::Drawing::Size(70, 24);
			...
			// button11
			// 
			this->button11->Location = System::Drawing::Point(2, 307);
			this->button11->Margin = System::Windows::Forms::Padding(2);
			this->button11->Name = L"button11";
			this->button11->Size = System::Drawing::Size(70, 24);
			...
			// button12
			// 
			this->button12->Location = System::Drawing::Point(2, 335);
			this->button12->Margin = System::Windows::Forms::Padding(2);
			this->button12->Name = L"button12";
			this->button12->Size = System::Drawing::Size(70, 24);
			...
			// button13
			// 
			this->button13->Location = System::Drawing::Point(2, 363);
			this->button13->Margin = System::Windows::Forms::Padding(2);
			this->button13->Name = L"button13";
			this->button13->Size = System::Drawing::Size(70, 24);
			...
			// button14
			// 
			this->button14->Location = System::Drawing::Point(2, 391);
			this->button14->Margin = System::Windows::Forms::Padding(2);
			this->button14->Name = L"button14";
			this->button14->Size = System::Drawing::Size(70, 24);
			...
			// button15
			// 
			this->button15->Location = System::Drawing::Point(2, 419);
			this->button15->Margin = System::Windows::Forms::Padding(2);
			this->button15->Name = L"button15";
			this->button15->Size = System::Drawing::Size(70, 24);
			...
			// button16
			// 
			this->button16->Location = System::Drawing::Point(2, 447);
			this->button16->Margin = System::Windows::Forms::Padding(2);
			this->button16->Name = L"button16";
			this->button16->Size = System::Drawing::Size(70, 24);
			...
			// button17
			// 
			this->button17->Location = System::Drawing::Point(2, 475);
			this->button17->Margin = System::Windows::Forms::Padding(2);
			this->button17->Name = L"button17";
			this->button17->Size = System::Drawing::Size(70, 24);
			...
			// button18
			// 
			this->button18->Location = System::Drawing::Point(2, 503);
			this->button18->Margin = System::Windows::Forms::Padding(2);
			this->button18->Name = L"button18";
			this->button18->Size = System::Drawing::Size(70, 24);
			...
			// button19
			// 
			this->button19->Location = System::Drawing::Point(2, 531);
			this->button19->Margin = System::Windows::Forms::Padding(2);
			this->button19->Name = L"button19";
			this->button19->Size = System::Drawing::Size(70, 24);
			...
			// button20
			// 
			this->button20->Location = System::Drawing::Point(2, 559);
			this->button20->Margin = System::Windows::Forms::Padding(2);
			this->button20->Name = L"button20";
			this->button20->Size = System::Drawing::Size(70, 24);
			...
			// button21
			// 
			this->button21->Location = System::Drawing::Point(2, 587);
			this->button21->Margin = System::Windows::Forms::Padding(2);
			this->button21->Name = L"button21";
			this->button21->Size = System::Drawing::Size(70, 24);
			...
			// button22
			// 
			this->button22->Location = System::Drawing::Point(2, 615);
			this->button22->Margin = System::Windows::Forms::Padding(2);
			this->button22->Name = L"button22";
			this->button22->Size = System::Drawing::Size(70, 24);
			...
			// button23
			// 
			this->button23->Location = System::Drawing::Point(2, 643);
			this->button23->Margin = System::Windows::Forms::Padding(2);
			this->button23->Name = L"button23";
			this->button23->Size = System::Drawing::Size(70, 24);
			...
			this->label65->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(238)));
			this->label65->Location = System::Drawing::Point(767, 37);
			this->label65->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->label65->Name = L"label65";
			this->label65->Size = System::Drawing::Size(103, 20);
			this->label65->TabIndex = 66;
			this->label65->Text = L"Active Player:";
			...
			this->DBoard->Location = System::Drawing::Point(35, 37);
			this->DBoard->Margin = System::Windows::Forms::Padding(2);
			...
			this->DBoard->RowStyles->Add((gcnew System::Windows::Forms::RowStyle(System::Windows::Forms::SizeType::Percent, 12.5F)));
			this->DBoard->RowStyles->Add((gcnew System::Windows::Forms::RowStyle(System::Windows::Forms::SizeType::Percent, 12.5F)));
			this->DBoard->RowStyles->Add((gcnew System::Windows::Forms::RowStyle(System::Windows::Forms::SizeType::Absolute, 16)));
			this->DBoard->Size = System::Drawing::Size(700, 700);
			...
			this->pictureBox76->Location = System::Drawing::Point(435, 609);
			this->pictureBox76->Margin = System::Windows::Forms::Padding(0);
			this->pictureBox76->Name = L"pictureBox76";
			this->pictureBox76->Size = System::Drawing::Size(87, 91);
			...
			this->pictureBox75->Location = System::Drawing::Point(348, 609);
			this->pictureBox75->Margin = System::Windows::Forms::Padding(0);
			this->pictureBox75->Name = L"pictureBox75";
			this->pictureBox75->Size = System::Drawing::Size(87, 91);
			...
			this->pictureBox74->Location = System::Drawing::Point(261, 609);
			this->pictureBox74->Margin = System::Windows::Forms::Padding(0);
			this->pictureBox74->Name = L"pictureBox74";
			this->pictureBox74->Size = System::Drawing::Size(87, 91);
			...
			this->pictureBox73->Location = System::Drawing::Point(174, 609);
			this->pictureBox73->Margin = System::Windows::Forms::Padding(0);
			this->pictureBox73->Name = L"pictureBox73";
			this->pictureBox73->Size = System::Drawing::Size(87, 91);
			...
			this->pictureBox72->Location = System::Drawing::Point(87, 609);
			this->pictureBox72->Margin = System::Windows::Forms::Padding(0);
			this->pictureBox72->Name = L"pictureBox72";
			this->pictureBox72->Size = System::Drawing::Size(87, 91);
			...
			this->pictureBox71->Location = System::Drawing::Point(0, 609);
			this->pictureBox71->Margin = System::Windows::Forms::Padding(0);
			this->pictureBox71->Name = L"pictureBox71";
			this->pictureBox71->Size = System::Drawing::Size(87, 91);
			...
			this->pictureBox70->Location = System::Drawing::Point(609, 522);
			this->pictureBox70->Margin = System::Windows::Forms::Padding(0);
			this->pictureBox70->Name = L"pictureBox70";
			this->pictureBox70->Size = System::Drawing::Size(91, 87);
			...
			this->pictureBox69->Location = System::Drawing::Point(522, 522);
			this->pictureBox69->Margin = System::Windows::Forms::Padding(0);
			this->pictureBox69->Name = L"pictureBox69";
			this->pictureBox69->Size = System::Drawing::Size(87, 87);
			...
			this->pictureBox68->Location = System::Drawing::Point(435, 522);
			this->pictureBox68->Margin = System::Windows::Forms::Padding(0);
			this->pictureBox68->Name = L"pictureBox68";
			this->pictureBox68->Size = System::Drawing::Size(87, 87);
			...
			this->pictureBox67->Location = System::Drawing::Point(348, 522);
			this->pictureBox67->Margin = System::Windows::Forms::Padding(0);
			this->pictureBox67->Name = L"pictureBox67";
			this->pictureBox67->Size = System::Drawing::Size(87, 87);
			...
			this->pictureBox66->Location = System::Drawing::Point(261, 522);
			this->pictureBox66->Margin = System::Windows::Forms::Padding(0);
			this->pictureBox66->Name = L"pictureBox66";
			this->pictureBox66->Size = System::Drawing::Size(87, 87);
			...
			this->pictureBox65->Location = System::Drawing::Point(174, 522);
			this->pictureBox65->Margin = System::Windows::Forms::Padding(0);
			this->pictureBox65->Name = L"pictureBox65";
			this->pictureBox65->Size = System::Drawing::Size(87, 87);
			...
			this->pictureBox64->Location = System::Drawing::Point(87, 522);
			this->pictureBox64->Margin = System::Windows::Forms::Padding(0);
			this->pictureBox64->Name = L"pictureBox64";
			this->pictureBox64->Size = System::Drawing::Size(87, 87);
			...
			this->pictureBox63->Location = System::Drawing::Point(0, 522);
			this->pictureBox63->Margin = System::Windows::Forms::Padding(0);
			this->pictureBox63->Name = L"pictureBox63";
			this->pictureBox63->Size = System::Drawing::Size(87, 87);
			...
			this->pictureBox62->Location = System::Drawing::Point(609, 435);
			this->pictureBox62->Margin = System::Windows::Forms::Padding(0);
			this->pictureBox62->Name = L"pictureBox62";
			this->pictureBox62->Size = System::Drawing::Size(91, 87);
			...
			this->pictureBox61->Location = System::Drawing::Point(522, 435);
			this->pictureBox61->Margin = System::Windows::Forms::Padding(0);
			this->pictureBox61->Name = L"pictureBox61";
			this->pictureBox61->Size = System::Drawing::Size(87, 87);
			...
			this->pictureBox60->Location = System::Drawing::Point(435, 435);
			this->pictureBox60->Margin = System::Windows::Forms::Padding(0);
			this->pictureBox60->Name = L"pictureBox60";
			this->pictureBox60->Size = System::Drawing::Size(87, 87);
			...
			this->pictureBox59->Location = System::Drawing::Point(348, 435);
			this->pictureBox59->Margin = System::Windows::Forms::Padding(0);
			this->pictureBox59->Name = L"pictureBox59";
			this->pictureBox59->Size = System::Drawing::Size(87, 87);
			...
			this->pictureBox58->Location = System::Drawing::Point(261, 435);
			this->pictureBox58->Margin = System::Windows::Forms::Padding(0);
			this->pictureBox58->Name = L"pictureBox58";
			this->pictureBox58->Size = System::Drawing::Size(87, 87);
			...
			this->pictureBox57->Location = System::Drawing::Point(174, 435);
			this->pictureBox57->Margin = System::Windows::Forms::Padding(0);
			this->pictureBox57->Name = L"pictureBox57";
			this->pictureBox57->Size = System::Drawing::Size(87, 87);
			...
			this->pictureBox56->Location = System::Drawing::Point(87, 435);
			this->pictureBox56->Margin = System::Windows::Forms::Padding(0);
			this->pictureBox56->Name = L"pictureBox56";
			this->pictureBox56->Size = System::Drawing::Size(87, 87);
			...
			this->pictureBox55->Location = System::Drawing::Point(0, 435);
			this->pictureBox55->Margin = System::Windows::Forms::Padding(0);
			this->pictureBox55->Name = L"pictureBox55";
			this->pictureBox55->Size = System::Drawing::Size(87, 87);
			...
			this->pictureBox54->Location = System::Drawing::Point(609, 348);
			this->pictureBox54->Margin = System::Windows::Forms::Padding(0);
			this->pictureBox54->Name = L"pictureBox54";
			this->pictureBox54->Size = System::Drawing::Size(91, 87);
			...
			this->pictureBox53->Location = System::Drawing::Point(522, 348);
			this->pictureBox53->Margin = System::Windows::Forms::Padding(0);
			this->pictureBox53->Name = L"pictureBox53";
			this->pictureBox53->Size = System::Drawing::Size(87, 87);
			...
			this->pictureBox52->Location = System::Drawing::Point(435, 348);
			this->pictureBox52->Margin = System::Windows::Forms::Padding(0);
			this->pictureBox52->Name = L"pictureBox52";
			this->pictureBox52->Size = System::Drawing::Size(87, 87);
			...
			this->pictureBox51->Location = System::Drawing::Point(348, 348);
			this->pictureBox51->Margin = System::Windows::Forms::Padding(0);
			this->pictureBox51->Name = L"pictureBox51";
			this->pictureBox51->Size = System::Drawing::Size(87, 87);
			...
			this->pictureBox50->Location = System::Drawing::Point(261, 348);
			this->pictureBox50->Margin = System::Windows::Forms::Padding(0);
			this->pictureBox50->Name = L"pictureBox50";
			this->pictureBox50->Size = System::Drawing::Size(87, 87);
			...
			this->pictureBox49->Location = System::Drawing::Point(174, 348);
			this->pictureBox49->Margin = System::Windows::Forms::Padding(0);
			this->pictureBox49->Name = L"pictureBox49";
			this->pictureBox49->Size = System::Drawing::Size(87, 87);
			...
			this->pictureBox48->Location = System::Drawing::Point(87, 348);
			this->pictureBox48->Margin = System::Windows::Forms::Padding(0);
			this->pictureBox48->Name = L"pictureBox48";
			this->pictureBox48->Size = System::Drawing::Size(87, 87);
			...
			this->pictureBox47->Location = System::Drawing::Point(0, 348);
			this->pictureBox47->Margin = System::Windows::Forms::Padding(0);
			this->pictureBox47->Name = L"pictureBox47";
			this->pictureBox47->Size = System::Drawing::Size(87, 87);
			...
			this->pictureBox46->Location = System::Drawing::Point(609, 261);
			this->pictureBox46->Margin = System::Windows::Forms::Padding(0);
			this->pictureBox46->Name = L"pictureBox46";
			this->pictureBox46->Size = System::Drawing::Size(91, 87);
			...
			this->pictureBox45->Location = System::Drawing::Point(522, 261);
			this->pictureBox45->Margin = System::Windows::Forms::Padding(0);
			this->pictureBox45->Name = L"pictureBox45";
			this->pictureBox45->Size = System::Drawing::Size(87, 87);
			...
			this->pictureBox44->Location = System::Drawing::Point(435, 261);
			this->pictureBox44->Margin = System::Windows::Forms::Padding(0);
			this->pictureBox44->Name = L"pictureBox44";
			this->pictureBox44->Size = System::Drawing::Size(87, 87);
			...
			this->pictureBox43->Location = System::Drawing::Point(348, 261);
			this->pictureBox43->Margin = System::Windows::Forms::Padding(0);
			this->pictureBox43->Name = L"pictureBox43";
			this->pictureBox43->Size = System::Drawing::Size(87, 87);
			...
			this->pictureBox42->Location = System::Drawing::Point(261, 261);
			this->pictureBox42->Margin = System::Windows::Forms::Padding(0);
			this->pictureBox42->Name = L"pictureBox42";
			this->pictureBox42->Size = System::Drawing::Size(87, 87);
			...
			this->pictureBox41->Location = System::Drawing::Point(174, 261);
			this->pictureBox41->Margin = System::Windows::Forms::Padding(0);
			this->pictureBox41->Name = L"pictureBox41";
			this->pictureBox41->Size = System::Drawing::Size(87, 87);
			...
			this->pictureBox40->Location = System::Drawing::Point(87, 261);
			this->pictureBox40->Margin = System::Windows::Forms::Padding(0);
			this->pictureBox40->Name = L"pictureBox40";
			this->pictureBox40->Size = System::Drawing::Size(87, 87);
			...
			this->pictureBox39->Location = System::Drawing::Point(0, 261);
			this->pictureBox39->Margin = System::Windows::Forms::Padding(0);
			this->pictureBox39->Name = L"pictureBox39";
			this->pictureBox39->Size = System::Drawing::Size(87, 87);
			...
			this->pictureBox38->Location = System::Drawing::Point(609, 174);
			this->pictureBox38->Margin = System::Windows::Forms::Padding(0);
			this->pictureBox38->Name = L"pictureBox38";
			this->pictureBox38->Size = System::Drawing::Size(91, 87);
			...
			this->pictureBox37->Location = System::Drawing::Point(522, 174);
			this->pictureBox37->Margin = System::Windows::Forms::Padding(0);
			this->pictureBox37->Name = L"pictureBox37";
			this->pictureBox37->Size = System::Drawing::Size(87, 87);
			...
			this->pictureBox36->Location = System::Drawing::Point(435, 174);
			this->pictureBox36->Margin = System::Windows::Forms::Padding(0);
			this->pictureBox36->Name = L"pictureBox36";
			this->pictureBox36->Size = System::Drawing::Size(87, 87);
			...
			this->pictureBox35->Location = System::Drawing::Point(348, 174);
			this->pictureBox35->Margin = System::Windows::Forms::Padding(0);
			this->pictureBox35->Name = L"pictureBox35";
			this->pictureBox35->Size = System::Drawing::Size(87, 87);
			...
			this->pictureBox34->Location = System::Drawing::Point(261, 174);
			this->pictureBox34->Margin = System::Windows::Forms::Padding(0);
			this->pictureBox34->Name = L"pictureBox34";
			this->pictureBox34->Size = System::Drawing::Size(87, 87);
			...
			this->pictureBox33->Location = System::Drawing::Point(174, 174);
			this->pictureBox33->Margin = System::Windows::Forms::Padding(0);
			this->pictureBox33->Name = L"pictureBox33";
			this->pictureBox33->Size = System::Drawing::Size(87, 87);
			...
			this->pictureBox32->Location = System::Drawing::Point(87, 174);
			this->pictureBox32->Margin = System::Windows::Forms::Padding(0);
			this->pictureBox32->Name = L"pictureBox32";
			this->pictureBox32->Size = System::Drawing::Size(87, 87);
			...
			this->pictureBox31->Location = System::Drawing::Point(0, 174);
			this->pictureBox31->Margin = System::Windows::Forms::Padding(0);
			this->pictureBox31->Name = L"pictureBox31";
			this->pictureBox31->Size = System::Drawing::Size(87, 87);
			...
			this->pictureBox30->Location = System::Drawing::Point(609, 87);
			this->pictureBox30->Margin = System::Windows::Forms::Padding(0);
			this->pictureBox30->Name = L"pictureBox30";
			this->pictureBox30->Size = System::Drawing::Size(91, 87);
			...
			this->pictureBox29->Location = System::Drawing::Point(522, 87);
			this->pictureBox29->Margin = System::Windows::Forms::Padding(0);
			this->pictureBox29->Name = L"pictureBox29";
			this->pictureBox29->Size = System::Drawing::Size(87, 87);
			...
			this->pictureBox28->Location = System::Drawing::Point(435, 87);
			this->pictureBox28->Margin = System::Windows::Forms::Padding(0);
			this->pictureBox28->Name = L"pictureBox28";
			this->pictureBox28->Size = System::Drawing::Size(87, 87);
			...
			this->pictureBox27->Location = System::Drawing::Point(348, 87);
			this->pictureBox27->Margin = System::Windows::Forms::Padding(0);
			this->pictureBox27->Name = L"pictureBox27";
			this->pictureBox27->Size = System::Drawing::Size(87, 87);
			...
			this->pictureBox26->Location = System::Drawing::Point(261, 87);
			this->pictureBox26->Margin = System::Windows::Forms::Padding(0);
			this->pictureBox26->Name = L"pictureBox26";
			this->pictureBox26->Size = System::Drawing::Size(87, 87);
			...
			this->pictureBox25->Location = System::Drawing::Point(174, 87);
			this->pictureBox25->Margin = System::Windows::Forms::Padding(0);
			this->pictureBox25->Name = L"pictureBox25";
			this->pictureBox25->Size = System::Drawing::Size(87, 87);
			...
			this->pictureBox24->Location = System::Drawing::Point(87, 87);
			this->pictureBox24->Margin = System::Windows::Forms::Padding(0);
			this->pictureBox24->Name = L"pictureBox24";
			this->pictureBox24->Size = System::Drawing::Size(87, 87);
			...
			this->pictureBox23->Location = System::Drawing::Point(0, 87);
			this->pictureBox23->Margin = System::Windows::Forms::Padding(0);
			this->pictureBox23->Name = L"pictureBox23";
			this->pictureBox23->Size = System::Drawing::Size(87, 87);
			...
			this->pictureBox22->Location = System::Drawing::Point(609, 0);
			this->pictureBox22->Margin = System::Windows::Forms::Padding(0);
			this->pictureBox22->Name = L"pictureBox22";
			this->pictureBox22->Size = System::Drawing::Size(91, 87);
			...
			this->pictureBox21->Location = System::Drawing::Point(522, 0);
			this->pictureBox21->Margin = System::Windows::Forms::Padding(0);
			this->pictureBox21->Name = L"pictureBox21";
			this->pictureBox21->Size = System::Drawing::Size(87, 87);
			...
			this->pictureBox20->Location = System::Drawing::Point(435, 0);
			this->pictureBox20->Margin = System::Windows::Forms::Padding(0);
			this->pictureBox20->Name = L"pictureBox20";
			this->pictureBox20->Size = System::Drawing::Size(87, 87);
			...
			this->pictureBox19->Location = System::Drawing::Point(348, 0);
			this->pictureBox19->Margin = System::Windows::Forms::Padding(0);
			this->pictureBox19->Name = L"pictureBox19";
			this->pictureBox19->Size = System::Drawing::Size(87, 87);
			...
			this->pictureBox18->Location = System::Drawing::Point(261, 0);
			this->pictureBox18->Margin = System::Windows::Forms::Padding(0);
			this->pictureBox18->Name = L"pictureBox18";
			this->pictureBox18->Size = System::Drawing::Size(87, 87);
			...
			this->pictureBox17->Location = System::Drawing::Point(174, 0);
			this->pictureBox17->Margin = System::Windows::Forms::Padding(0);
			this->pictureBox17->Name = L"pictureBox17";
			this->pictureBox17->Size = System::Drawing::Size(87, 87);
			...
			this->pictureBox16->Location = System::Drawing::Point(87, 0);
			this->pictureBox16->Margin = System::Windows::Forms::Padding(0);
			this->pictureBox16->Name = L"pictureBox16";
			this->pictureBox16->Size = System::Drawing::Size(87, 87);
			...
			this->pictureBox15->Size = System::Drawing::Size(87, 87);
			...
			this->ActivePlayerName->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(238)));
			this->ActivePlayerName->Location = System::Drawing::Point(923, 37);
			this->ActivePlayerName->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->ActivePlayerName->Name = L"ActivePlayerName";
			this->ActivePlayerName->Size = System::Drawing::Size(14, 20);
			...
			this->backButton->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(238)));
			this->backButton->Location = System::Drawing::Point(771, 677);
			...
			this->label66->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(238)));
			this->label66->Location = System::Drawing::Point(68, 9);
			this->label66->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->label66->Name = L"label66";
			this->label66->Size = System::Drawing::Size(19, 20);
			...
			this->label68->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(238)));
			this->label68->Location = System::Drawing::Point(160, 9);
			this->label68->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->label68->Name = L"label68";
			this->label68->Size = System::Drawing::Size(19, 20);
			...
			this->label69->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(238)));
			this->label69->Location = System::Drawing::Point(246, 9);
			this->label69->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->label69->Name = L"label69";
			this->label69->Size = System::Drawing::Size(18, 20);
			...
			this->label70->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(238)));
			this->label70->Location = System::Drawing::Point(329, 9);
			this->label70->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->label70->Name = L"label70";
			this->label70->Size = System::Drawing::Size(19, 20);
			...
			this->label71->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(238)));
			this->label71->Location = System::Drawing::Point(419, 9);
			this->label71->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->label71->Name = L"label71";
			this->label71->Size = System::Drawing::Size(19, 20);
			...
			this->label67->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(238)));
			this->label67->Location = System::Drawing::Point(508, 9);
			this->label67->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->label67->Name = L"label67";
			this->label67->Size = System::Drawing::Size(15, 20);
			...
			this->label72->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(238)));
			this->label72->Location = System::Drawing::Point(590, 9);
			...
			this->label73->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(238)));
			this->label73->Location = System::Drawing::Point(680, 9);
			this->label73->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->label73->Name = L"label73";
			this->label73->Size = System::Drawing::Size(19, 20);
			...
			this->label74->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(238)));
			this->label74->Location = System::Drawing::Point(7, 66);
			this->label74->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->label74->Name = L"label74";
			this->label74->Size = System::Drawing::Size(19, 20);
			...
			this->label75->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(238)));
			this->label75->Location = System::Drawing::Point(7, 154);
			this->label75->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->label75->Name = L"label75";
			this->label75->Size = System::Drawing::Size(19, 20);
			...
			this->label76->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(238)));
			this->label76->Location = System::Drawing::Point(7, 247);
			this->label76->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->label76->Name = L"label76";
			this->label76->Size = System::Drawing::Size(19, 20);
			...
			this->label77->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(238)));
			this->label77->Location = System::Drawing::Point(7, 331);
			this->label77->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->label77->Name = L"label77";
			this->label77->Size = System::Drawing::Size(19, 20);
			...
			this->label78->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(238)));
			this->label78->Location = System::Drawing::Point(7, 416);
			this->label78->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->label78->Name = L"label78";
			this->label78->Size = System::Drawing::Size(19, 20);
			...
			this->label79->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(238)));
			this->label79->Location = System::Drawing::Point(7, 503);
			this->label79->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->label79->Name = L"label79";
			this->label79->Size = System::Drawing::Size(19, 20);
			...
			this->label80->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(238)));
			this->label80->Location = System::Drawing::Point(7, 599);
			...
			this->label81->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(238)));
			this->label81->Location = System::Drawing::Point(7, 677);
			this->label81->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->label81->Name = L"label81";
			this->label81->Size = System::Drawing::Size(19, 20);
			...
			this->label82->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(238)));
			this->label82->Location = System::Drawing::Point(767, 66);
			this->label82->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->label82->Name = L"label82";
			this->label82->Size = System::Drawing::Size(100, 20);
			...
			// exitGameButton
			// 
			this->exitGameButton->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(238)));
			this->exitGameButton->Location = System::Drawing::Point(931, 677);
			this->exitGameButton->Margin = System::Windows::Forms::Padding(2);
			this->exitGameButton->Name = L"exitGameButton";
			this->exitGameButton->Size = System::Drawing::Size(150, 60);
			this->exitGameButton->TabIndex = 88;
			this->exitGameButton->Text = L"Exit Game";
			this->exitGameButton->UseVisualStyleBackColor = true;
			this->exitGameButton->Click += gcnew System::EventHandler(this, &MainForm::endGameButtonClick);
			// 
			// MainForm
			// 
